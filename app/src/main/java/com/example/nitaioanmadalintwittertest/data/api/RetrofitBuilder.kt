...
import com.example.nitaioanmadalintwittertest.BuildConfig
...
object RetrofitBuilder {
    ...
    val apiTwitterService: ApiService =
        createRetrofitService(clazz = ApiService::class.java, baseUrl = BuildConfig.BASE_URL_TWITTER, accessTokenHeaderNedeed = true)
